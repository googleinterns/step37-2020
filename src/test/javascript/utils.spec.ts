...
import { fallOnSameDay } from '../../main/webapp/utils';
...
describe('Utility functions', () => {
  describe('fallOnSameDay', () => {
    it('Should work for equal times', () => {
      ...
      strictEqual(fallOnSameDay(date1.getTime(), date2.getTime()), true);
    });
    ...
    it('Should detect exact 24 hour difference', () => {
      ...
      strictEqual(fallOnSameDay(date1.getTime(), date2.getTime()), false);
    });
  });
});
